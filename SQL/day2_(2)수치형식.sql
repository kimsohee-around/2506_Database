...
-- 유효 숫자 :   1000 (모든 0 이 유효함.)     00100 (1 앞에 0 2개는 유효 숫자가 아님)
--               0.0001 (모든 0 이 유효함.)   0.000100  (1 뒤에 0 2개는 유효 숫자가 아님)
...
INSERT INTO TBL_NUMBER(zcol) values (1245.454);  -- 1245.45  (소수점 이하 2자리로 맞출 수 있음)
